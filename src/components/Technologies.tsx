...
const buttons = [
  ...
  },
  {
    href: "https://mui.com/",
    icon: (
      <SiMui color="default" className="duration-200 group-hover:-rotate-12" />
    ),
    name: "Material UI",
  },
  {
  ...
  },
  {
    ...
    icon: (
      <SiGit color="default" className="duration-200 group-hover:-rotate-12" />
    ),
    name: "Git",
  },
  {
  ...
  },
  {
    ...
    icon: (
      <SiJest color="default" className="duration-200 group-hover:-rotate-12" />
    ),
    name: "Jest",
  },
  {
...
export const Technologies = () => {
  return (
    <section id="technologies" className="mt-20 mb-16 scroll-mt-20">
      ...
      <TechnologyList buttons={buttons} />
